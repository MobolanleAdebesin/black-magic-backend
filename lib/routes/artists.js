 ...
 * @apiName getOccupation
 * @apiGroup Artists
 *
 * @apiParam {String} occupation Artist occupation, must be musician, artist, or beauty
 *
 * @apiSuccess {Object[]} Array An array of artists
 */
...
/**
 * @api {delete} /artists/remove/:name Delete artist
 * @apiName deleteArtist
 * @apiGroup Artists
 *
 * @apiParam {String} remove Remove artist from page
 */
router.route("/add").post((req, res) => {
  Artist.create(req.body)
    .then(artist => {
...
/**
 * @api {put} /artists/update/:name Update artist
 * @apiName updateArtist
 * @apiGroup Artists
 *
 * @apiParam {String} update Update artist info
 *
 */
